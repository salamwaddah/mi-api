...
module.exports = class extends (
  ...
  setFavoriteLevel(level) {
    const realFavoriteLevel = this.serviceMapping['favorite_level'].mapping(
      level
    );

    return this.call('set_properties', [
      Object.assign(
        { value: realFavoriteLevel },
        this.getServiceProperty('favorite_level')
      ),
    ]).then(() => null);
  }
  ...
  changeLEDBrightness(level) {
    ...
    return this.call('set_properties', [
      Object.assign({ value: level }, this.getServiceProperty('led_b')),
    ]).then(() => null);
  }
};
